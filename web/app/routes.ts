...
export default [
    ...
    route("dev/blink-preview", "routes/dev.blink-preview.tsx"),
    route("blink/invest/:listingId", "routes/blink.invest.$listingId.tsx"),
    route("blink/book/:listingId", "routes/blink.book.$listingId.tsx"),
