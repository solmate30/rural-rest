...
**리서치 근거:** [21_GYEONGJU_PILOT_DATA_RESEARCH.md](../01_Concept_Design/21_GYEONGJU_PILOT_DATA_RESEARCH.md) 참조
...
### 5.1. 가격 근거
- **21_GYEONGJU_PILOT_DATA_RESEARCH.md Section 3**: 경주 한옥 숙박 시세 조사
- 황리단길 한옥: 70,000~90,000원
- 도미토리: 25,000원 (배낭족 타겟)
- 농촌 지역: 55,000~65,000원 (농촌 할인)

### 5.2. 빈집 리서치 근거
- **21_GYEONGJU_PILOT_DATA_RESEARCH.md Section 4**: 폐가정비사업 실제 기록
...
- [21_GYEONGJU_PILOT_DATA_RESEARCH.md](../01_Concept_Design/21_GYEONGJU_PILOT_DATA_RESEARCH.md) - 시장 조사 및 리서치 근거
