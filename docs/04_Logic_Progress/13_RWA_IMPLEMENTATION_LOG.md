...
- **Specs**: [14. RWA Issuance Spec](../03_Technical_Specs/14_RWA_ISSUANCE_SPEC.md) - RWA 발행 구현 명세 (착수 전 체크리스트, Anchor, 매수 플로우)
...
- **Logic**: [14. RWA Real-Time Dividend Logic](./14_RWA_REAL_TIME_DIVIDEND_LOGIC.md) - 배당 로직
- **Archive**: [12. RWA Tokenization Logic](../00_ARCHIVE/future_blockchain/12_RWA_TOKENIZATION_LOGIC.md) - 토큰화 파이프라인 (참고용)
- **QA**: [RWA_ISSUANCE_TEST_SCENARIOS.md](../05_QA_Validation/RWA_ISSUANCE_TEST_SCENARIOS.md) - RWA 발행·매수 테스트 시나리오
