...
- **Concept_Design**: [09_DAO_GOVERNANCE_PLAN.md](../01_Concept_Design/09_DAO_GOVERNANCE_PLAN.md) - DAO 기획서 (본 명세의 기반)
- **Concept_Design**: [10_RWA_ISSUANCE_PLAN.md](../01_Concept_Design/10_RWA_ISSUANCE_PLAN.md) - RWA 발행 기획 (DAO Community Token = RWA)
