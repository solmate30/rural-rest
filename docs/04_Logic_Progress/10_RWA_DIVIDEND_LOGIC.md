# 10. RWA 월별 배당 분배 로직 (DeFi Staking Model)
...
- `docs/03_Technical_Specs/11_ANCHOR_PROGRAM_SPEC.md` — instruction 명세 및 수학 명세
- `docs/04_Logic_Progress/11_RWA_KNOWN_ISSUES.md` — Stage 2 미구현 항목
- `docs/04_Logic_Progress/12_RWA_FUNDING_ESCROW_LOGIC.md` — 펀딩 에스크로 로직
