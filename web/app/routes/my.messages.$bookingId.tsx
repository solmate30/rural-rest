...
import type { Route } from "./+types/my.messages.$bookingId";
...
export async function loader({ request, params }: Route.LoaderArgs) {
    ...
    // 상대방 이름 조회
    const partnerId = currentUser.id === booking.guestId ? booking.hostId : booking.guestId;
        ...
        <div className="flex flex-col h-[calc(100vh-180px)] min-h-[500px]">
            ...
            <div className="flex-1 overflow-y-auto bg-white rounded-3xl border border-stone-100 shadow-sm px-5 py-5 space-y-4">
                ...
                {msgs.map((m) => {
                    ...
                    // 내 메시지: 내가 입력한 원문 표시 / 상대 메시지: 번역문 표시
