...
## 5. Related Documents
- **Foundation**: [Product Specs](../01_Concept_&_Design/03_PRODUCT_SPECS.md) - 프로퍼티 상세 페이지 사이트맵 및 사용자 플로우 (Section 3.A.3)
- **Foundation**: [UI Design](../01_Concept_&_Design/05_UI_DESIGN.md) - 디자인 시스템 및 컬러 팔레트 (#8D6E63 Warm Brown)
- **Foundation**: [Happy Path Scenarios](../01_Concept_&_Design/07_HAPPY_PATH_SCENARIOS.md) - 게스트 시나리오 Step 2 (Village Story 몰입)
...
- **Logic**: [Transport Concierge](../04_Logic_&_Progress/05_TRANSPORT_CONCIERGE_LOGIC.md) - 교통 컨시어지 로직 및 Mock 데이터 모델
