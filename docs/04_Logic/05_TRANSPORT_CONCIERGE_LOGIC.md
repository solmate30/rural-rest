...
- **Prototype**: [Detail Page Review](../02_Prototype/01_DETAIL_PAGE_REVIEW.md) - Map Integration 이슈 (Mock으로 해결)
...
- **Specs**: [Property Detail Guide](../03_Specs/07_PROPERTY_DETAIL_IMPLEMENTATION_GUIDE.md) - Section 4.7-4.8 Mock 지도 및 교통 안내 UI 구현 상세
